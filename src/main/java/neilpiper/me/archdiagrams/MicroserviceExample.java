...
public class MicroserviceExample {
  ...
  public static void main(String[] args) throws Exception {
    Workspace workspace = new Workspace("Microservices example",
    ...
    DynamicView dynamicView = views.createDynamicView(mySoftwareSystem, "CustomerUpdateEvent",
    ...
    plantUMLWriter.addSkinParam("monochrome", "true");
    ...
    //plantUMLWriter.addSkinParam("rectangleBackgroundColor", "#SeaGreen");
